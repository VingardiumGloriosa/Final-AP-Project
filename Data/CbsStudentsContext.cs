    ...
    public class CbsStudentsContext : IdentityDbContext
    {
        ...
        private void UsersSeed(ModelBuilder builder)
        {
            ...
            var user2 = new IdentityUser
            {
                ...
                Email = "patrik@kea.dk",
                EmailConfirmed = true,
                UserName = "patrik@kea.dk",
            };

            PasswordHasher<IdentityUser> passHash = new PasswordHasher<IdentityUser>();
            user1.PasswordHash = passHash.HashPassword(user1, "minorOffense!");
            user2.PasswordHash = passHash.HashPassword(user2, "seaCucumber!");
